...
namespace constants{
   ...
   std::array<float,3> initPosition = {0,0,5000};
    ...
    std::array<float,3> initVehicleState = {1,1,0}; // this the vehicle vector, its direction is the directionthe nose points. it will be normilized, magnatiude is meain
    std::array<float , 3> MOI = {3614090,3614090,3614090};
    std::array<float,3> initVelocity = {-20,-20,0}; // m/s
