...
#include <array>
    ...
    namespace constants{
        ...
        std::array<float,3> initPosition = {0,0,500};
        ...
        std::array<float,3> initVehicleState = {0,.2,1}; // this the vehicle vector, its direction is the directionthe nose points. it will be normilized, magnatiude is meain

        std::array<float , 3> MOI = {100,100,100}; //get rid of this 
        float centerOfPressure = 2;
