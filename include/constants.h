...
#include <array>
    ...
    namespace constants{
        ...
        std::array<float,3> initVehicleState = {.3,.3,.4}; // this the vehicle vector, its direction is the directionthe nose points. it will be normilized, magnatiude is meain
