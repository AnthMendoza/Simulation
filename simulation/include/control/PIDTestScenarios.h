...
void hoverSetGain(PIDDroneController* testController , dataPID PID){
    testController->setPIDZGains(PID);
}

void hoverSetVeloGain(PIDDroneController* testController , dataPID PID){
    testController->setPIDVZGains(PID);
}



void hoverTestSetup(droneBody* testDrone,PIDDroneController* testController, dataPID PID){
...
void hoverSetGainDuel(PIDDroneController* testController , PIDPair PID){
...
void hoverTestSetupDuel(droneBody* testDrone,PIDDroneController* testController, PIDPair PID){
    //set drone vertically 
    testDrone->resetMotors();
    ...
    testController->setTargetPosition(0.0f,0.0f,wayPoint);
}
...
void aotSetGain(PIDDroneController* testController , dataPID PID){
    testController->setAPIDXGains(PID);
    testController->setAPIDYGains(PID);
}

void aotTestSetup(droneBody* testDrone,PIDDroneController* testController, dataPID PID){
    //set drone vertically 
    testDrone->resetMotors();
    ...
    testDrone->setVelocity(0.0f,0.0f,0.0f);
    testDrone->setMotorHover();
    testDrone->controller->setTargetPosition(0.0f,arbitraryLargeDistance,ALTITUDE);
}
...
void rollPitchSetGain(PIDDroneController* testController , PIDPair PID){
...
void rollPitchTestSetup(droneBody* testDrone,PIDDroneController* testController, PIDPair PID){
    //set drone vertically 
    testDrone->resetMotors();
    testDrone->setPositionVector(0.0f,0.0f,10.0f);
    testDrone->setStateVector({0,0,1},{1,0,0});
    ...
    testController->setTargetPosition(0.0f,horizontalWayPoint,testDrone->getPositionVector()[2]);
}
